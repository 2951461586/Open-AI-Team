...
export function createRemoteBrokerRuntimeAdapter({ manifestPath = '', workerEntryPath = '', brokerEntryPath = '', paths = {}, state = {}, eventBus = null, brokerCount = 2, clusterNodes = [], backendProvider = null, hostLayer = null } = {}) {
  let brokers = [];
