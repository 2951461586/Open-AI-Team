  ...
  sendJson(res, 200, buildStableEnvelope({
    ...
    payload: {
      ...
      summaryLinks: {
        ...
        evidence: `/state/team/evidence?taskId=${encodeURIComponent(String(taskId || ''))}&limit=200`,
        mailbox: `/state/team/mailbox?taskId=${encodeURIComponent(String(taskId || ''))}&limit=100`,
      },
      currentMemberKey: s.currentMemberKey,
      boundary: {
