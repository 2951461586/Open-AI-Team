...
const STEPS = [
  ...
  { key: 'publicDeployNoInstanceDefaults', label: 'public deploy no instance defaults smoke', cmd: ['node', 'scripts/team/team-public-deploy-no-instance-defaults-smoke.mjs'] },
  { key: 'p0ExecutionAuthority', label: 'P0 execution authority smoke', cmd: ['node', 'scripts/team/team-p0-execution-authority-smoke.mjs'] },
  { key: 'p1ProductSurfaceDeliveryClosure', label: 'P1 product surface / delivery closure smoke', cmd: ['node', 'scripts/team/team-p1-product-surface-delivery-closure-smoke.mjs'] },
  { key: 'p2MissionWorkbenchDeliverablesBoundary', label: 'P2 mission / workbench / deliverables boundary smoke', cmd: ['node', 'scripts/team/team-p2-mission-workbench-deliverables-boundary-smoke.mjs'] },
  { key: 'p3DeliverablesEvidenceAcceptance', label: 'P3 deliverables / evidence / acceptance smoke', cmd: ['node', 'scripts/team/team-p3-deliverables-evidence-acceptance-smoke.mjs'] },
  { key: 'p4TerminalStateArchiveEvidence', label: 'P4 terminal-state / archive / evidence smoke', cmd: ['node', 'scripts/team/team-p4-terminal-state-archive-evidence-smoke.mjs'] },
