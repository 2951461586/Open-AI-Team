...
export function createRemoteBrokerRuntimeAdapter({ manifestPath = '', workerEntryPath = '', brokerEntryPath = '', paths = {}, state = {}, eventBus = null, brokerCount = 2, clusterNodes = [] } = {}) {
  let brokers = [];
  ...
  async function sendToSession() {
    return { ok: false, error: 'send_unavailable', via: 'remote_broker_http' };
  }
