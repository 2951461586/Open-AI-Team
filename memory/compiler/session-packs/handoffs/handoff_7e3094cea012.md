# Session Handoff — handoff_7e3094cea012
...
Decisions: 精确问答先回源再答
Next actions: Check source backlinks after real import. | Regenerate backlinks and inspect lcm-summary/lcm-message coverage. | 补足 precise scene selector
