# Session Handoff — handoff_8fabd4139388
...
Decisions: 精确问答先回源再答
Next actions: 补足 precise scene selector | Check source backlinks and runtime source mix after import. | 验证 source backlinks 已覆盖 file / memory-item / session
